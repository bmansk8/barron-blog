    ...
    return (
        <div className="w_gallery">
            ...
            <p>
                ...
                These are all my wallpapers so far. They are all 16:9
                aspect-ratio. Sadly no standard pixel density since I used both
                my ultra wide and normal lens. These are from several occasions
                and a few from previous collections. My favorite is third from
                the top. Was on a hiking trip and a lot of fog had set in. One
                of my best photos yet in my opinion. Feel free to download these
                and use them for whatever you like!
            </p>
        </div>
    )
}
