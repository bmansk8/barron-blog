    ...
    return (
        <div className="gallery">
            ...
            <p>
                ...
                this collection is from three separate occasions. The first
                photo (top left) was on my daily run. It happened to be foggy
                that day, normally that part of the lake looks really ugly, so
                for such a great photo to come of it is pretty rare. The second
                one was in the midst of a recording session. It’s taken from
                within the studio. The rest were on an amazing hiking session
                around a reservoir near my house. Funny enough these are all on
                different days even thought the fog is somewhat consistent
                between them all.
            </p>
        </div>
    )
